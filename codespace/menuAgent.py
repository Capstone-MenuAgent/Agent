...
template = """
    ...
    [Response]
    나이, 성별, 하늘 상태, 기온, 별점, 리뷰수, tag를 고려해서 음식점 이름, 추천 메뉴, 주소를 알려줘.
    추천 메뉴는 음식점에서 한 가지만 정해서 알려줘.
    음식점 이름, 추천 메뉴는 " "로 묶어서 알려줘.
    답변은 두 줄 작성해줘.
    첫 줄은 하늘 상태, 기온과 "음식점 이름"의 "추천 메뉴"를 작성해줘.
    두 번째 줄은 "주소"를 알려줘
    아래는 예시야.
    하늘은 "하늘 상태" 기온은 "온도"입니다. "음식점 이름"의 "추천 메뉴"를 추천해드릴게요.
    "주소"
"""
...
def menuRecomment(question, loc, gender, age):
